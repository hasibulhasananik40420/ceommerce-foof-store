...
const Footer = () => {
    ...
    // Render footer only if the current route is not the login page
    const renderFooter = location.pathname !== '/login';
    const renderFootersingup = location.pathname !== '/singup';

    return (
        <>

            {
                renderFooter && renderFootersingup && (<div>
